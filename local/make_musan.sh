...
utils/subset_data_dir.sh --utt-list local/musan.tmp/utt2spk_speech \
  ${data_dir}/musan ${data_dir}/musan_speech_many
...
utils/fix_data_dir.sh ${data_dir}/musan_speech_many
utils/fix_data_dir.sh ${data_dir}/musan_noise

## Generate mixed data 25h 36m(99200s)
hhjo/speech_reduce.sh --total_time 99200 ${data_dir}/musan_speech_many ${data_dir}/musan_speech 
