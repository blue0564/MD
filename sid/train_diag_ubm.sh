...
all_feats="ark,s,cs:add-deltas $delta_opts scp:$data/feats.scp ark:- | apply-cmvn-sliding --norm-vars=false --center=true --cmn-window=$cmn_window ark:- ark:- | select-voiced-frames ark:- scp,s,cs:$data/vad.scp ark:- |"
